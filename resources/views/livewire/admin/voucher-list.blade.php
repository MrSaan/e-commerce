    ...
    <table class="w-full">
        <thead>
            <tr class="capitalize text-base text-gray-600 border-b-[1px]">
                <th scope="col">id</th>
                <th scope="col" class="border-l-[1px]">code</th>
                <th scope="col" class="border-l-[1px]">type</th>
                <th scope="col" class="border-l-[1px]">value</th>
        ...
        <tbody>
            ...
            <tr x-data="{modal{{$item->id}}: false}">
                ...
                <td class="pl-2 py-2">{{$item->code}}</td>
                <td class="pl-2 py-2">{{$item->type}}</td>
                @if ($item->value != null)
                <td class="pl-2 py-2">${{$item->value}}</td>
                @else
                <td class="pl-2 py-2">{{$item->percent_off}}%</td>
                @endif
                                        ...
                                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                            ...
                                            <div>
                                                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                                                    <div>
                                                        <label class="text-gray-700 dark:text-gray-200" for="name">code</label>
                                                        <input id="name" type="text" wire:model="code" placeholder="{{$item->code}}"
                                                    ...
                                                    <div class="flex flex-col gap-2">
                                                        ...
                                                        <x-dropdown id="type">
                                                            ...
                                                            <x-dropdown-item wire:click="$set('type', 'fixed')">Fixed</x-dropdown-item>
                                                            <x-dropdown-item wire:click="$set('type', 'percent')">Percent</x-dropdown-item>
                                                        </x-dropdown>                                           
                                                    ...
                                                    @if ($item->value != null)
                                                    <div>
                                                        <label class="text-gray-700 dark:text-gray-200" for="slug">value</label>
                                                        <input id="value" type="text" wire:model="value" placeholder="{{$item->value}}"
                                                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input id="percent_off" type="text" wire:model="percent_off" placeholder="{{$item->percent_off}}"
                                                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
