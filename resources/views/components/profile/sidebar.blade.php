<div class="flex flex-col w-full h-screen py-8 bg-white border-r md:w-72 dark:bg-gray-800 dark:border-gray-600">
    <div class="flex flex-col items-center mt-6 -mx-2">
        <img class="object-cover w-24 h-24 mx-2 rounded-full" src="{{asset('/storage/'. auth()->user()->thumbnail)}}"
            alt="avatar">
        <h4 class="mx-2 mt-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">{{auth()->user()->username}}
        </h4>
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
                ...
                <span class="mx-4 font-medium">Voucher</span>
            </a>
