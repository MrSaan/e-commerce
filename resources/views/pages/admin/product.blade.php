...
<div class="flex flex-col md:flex-row">
    ...
    <div x-data="{ tab: 'product'}" class="bg-gray-100 w-full py-10">

        <div class="flex mx-auto w-full px-10">
            <button @click.prevent="tab = 'product'"
                :class="{ 'border border-b-0 border-gray-300 rounded-t-md bg-white' : tab === 'product'}"
        ...
        <div x-show="tab === 'product'" class="w-auto bg-white mx-10 py-6">
