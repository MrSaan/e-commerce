...
<div class="flex flex-col md:flex-row">
    ...
    <div x-data="{ tab: 'voucher'}" class="bg-gray-100 w-full py-10">

        <div class="flex mx-auto w-full px-10">
            <button @click.prevent="tab = 'voucher'"
                :class="{ 'border border-b-0 border-gray-300 rounded-t-md bg-white' : tab === 'voucher'}"
        ...
        <div x-show="tab === 'voucher'" class="w-auto bg-white mx-10 py-6">
            <livewire:admin.voucher-list />
        </div>
        <div x-show="tab === 'add'" class="w-auto bg-white mx-10 py-6">
            <livewire:admin.voucher-add />
        </div>
    </div>
</div>
