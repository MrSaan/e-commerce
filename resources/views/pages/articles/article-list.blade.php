    ...
    <div class="bg-white dark:bg-gray-800">
        <div class="container p-6 mx-auto">
            <div class="flex flex-col lg:gap-4 gap-2">
                <span
                    class="block text-base text-center text-gray-800 dark:text-white md:text-xl hover:text-gray-700 dark:hover:text-gray-300">
                    Our Blog
                </span>
                <span
                    class="block text-3xl font-bold text-center text-gray-800 dark:text-white md:text-5xl lg:tracking-wide hover:text-gray-700 dark:hover:text-gray-300">
                    Stories & Ideas
                </span>
                <span class="block text-[9px] md:text-sm text-center text-gray-600 dark:text-white lg:tracking-wide">
                    The latest news to drive business strategy.
                </span>
            </div>

            <div class="flex items-center justify-center mt-12 text-gray-600 capitalize dark:text-gray-300">
...
<main class="max-w-5xl mx-auto mt-6 lg:mt-20 space-y-6">
